                ...
                <tr key={r.short_code} className="border-t border-[var(--border)] hover:bg-[color-mix(in_oklab,var(--accent)_8%,var(--surface))] transition-colors">
                  ...
                  <td className="p-3 text-right">
                    <div className="inline-flex items-center gap-2">
                      <button
                        className="btn btn-secondary h-9 inline-flex items-center gap-1 transition hover:opacity-90"
                        onClick={() => {
                      ...
                      <button
                        className="btn btn-secondary h-9 transition hover:opacity-90"
                        onClick={async () => {
              ...
              {qrDataUrl ? (
                <>
                  ...
                  <div className="flex flex-wrap justify-center gap-2 w-full">
                    <a className="btn btn-primary h-9" href={qrDataUrl} download={`qr-${qrFor.replace(`${origin}/`, '')}.png`}>
                      Download PNG
                    </a>
                  </div>
